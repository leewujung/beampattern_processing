...
chk_indiv_call = 0;
track_cut_idx = 1:800;
save_dir = ['C:\Users\',username,'\Dropbox\0_ANALYSIS\bp_processing\proc_output_rousettus_new'];
...
for tnum = trial_to_proc
    ...
    data.track.head_aim_est_time_diff = 0.05;  % time span between points used for estimating head aim from bat position
    data.track.head_n_prescribe = [0,0,1];  % precribed head normal vector (+z axis)
